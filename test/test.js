...
var time1 = new Date();
var hm = new heatmap(700, 1000, heatmap.LAYOUTS.CENTERFIXEDWIDTH, data, heatmap.BLOBTYPE.LARGE, function () {
    var time2 = new Date();
    var res = hm.compile();
    var time3 = new Date();
    hm.getPNG(500, function (dta) {
        ...
        fs.writeFile("test/test.png", dta, function (err) {
            ...
            console.log("The click heatmap file was saved! Times: ", (time2 - time1), (time3 - time2), (time4 - time3));
        });
    });
});
